...
<body>
	<div id="interface">
<?php
//pega o valor que foi digitado pelo usuário e insiro na variável pelo metodo post
...
if(empty($funcao_funcionario) || empty($cpf_funcionario) || empty($nome_funcionario) || empty($senha_login) || empty($datanasc_funcionario) || empty($nome_funcionario) || empty($email_funcionario))
{
...
if($result=mysqli_query($conexao, "insert into TbFuncionario (funcao_funcionario, cpf_funcionario, nome_login, senha_login, datanasc_funcionario, nome_funcionario, email_funcionario) values ('$funcao_funcionario', '$cpf_funcionario', '$nome_login', '$senha_login', '$datanasc_funcionario', '$nome_funcionario', '$email_funcionario')") or mysqli_error())
{ 
echo"<script>alert('Funcionário adicionado com sucesso!');
