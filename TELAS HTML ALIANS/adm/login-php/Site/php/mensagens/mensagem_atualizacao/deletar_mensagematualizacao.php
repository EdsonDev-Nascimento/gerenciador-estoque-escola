...
$id_mensagematualizacao = $_GET['id'];

$sql = mysqli_query($conexao, "SELECT * FROM TbMensagem_atualizacao WHERE id_mensagematualizacao = '$id_mensagematualizacao'");
...
<html>
<head>
	<title>Deletar Mensagem Atualização</title>
...
<div class="container">
      ...
      <header>
        ...
        <ul>
        <li>
            <label for="CPF">Código da Mensagem</label>
            <input type="text" name="id_mensagematualizacao" readonly="true" value="<?php echo $result['id_mensagematualizacao']?>">
            <span>Código da Mensagem</span>
        </li>
        <li>
            <label for="Função">Nome do Funcionário</label>
            <input type="text" name="nome_mensagematualizacao" value="<?php echo $result['nome_mensagematualizacao']?>">
            <span>Nome do Funcionário</span>
        </li>
        <li>
            <label for="CPF">Mensagem</label>
           <input type="text" name="mensagem_atualizacao" readonly="true" value="<?php echo $result['mensagem_atualizacao']?>">
            <span>Mensagem do Funcionário</span>
        </li>
