...
<html>
<head>
  <title>Mensagens de Mudança de Senha</title>
...
<div class="container">
      ...
      <header>
            <form>
            <center>
              <center><div id="titulo">Mensagens de Mudança de Senha</div></center>
            <?php 
            ...
            $sql = "SELECT * FROM TbEsqueci_senha";
            ...
            if (mysqli_num_rows($rs) > 0) { //mysqli_num_rows: para obter quantas linhas foram retornadas para um comando SELECT, então enquanto o número de linhas for maior que zero ele continua a executar. 
             ...
             <?php
              ...
              while ($array=mysqli_fetch_array($rs)) {
                ...
                $id_esquecisenha= $array['id_esqueci_senha'];
                $nome_func= $array['nome_func'];
                $email_func= $array['email_func'];
                $cpf_func= $array['cpf_func'];
                ...
                <tr style="background: white; color: black; text-align: center"><td><?php echo "<center>", $id_esquecisenha , "</center>"?></td>
                <td ><?php echo "<center>", $nome_func, "</center>"?></td>
                <td><?php echo "<center>", $email_func, "</center>";?></td>
                <td><?php echo "<center>", $cpf_func, "</center>";?></td>
                <td><?php echo "<center>", $id_funcionario, "</center>";?></td>
               
                
                <td><center><a class="btn btn-warning btn-sm" title="Deletar" style="color:3fff; margin-bottom: 5px;" title="Deletar" href="deletar_esquecisenha.php?id=<?php echo $id_esquecisenha?>role="button"><i class=far fa-edit"></i><img src="../../../../Imagens/lixeira.png" style="width: 20px; height: 20px"></a>

                  <a class="btn btn-warning btn-sm" title="Mudar Senha" style="color:3fff; margin-bottom: 5px;" title="Deletar" href="mudar.php?id=<?php echo $id_funcionario?>role="button"><i class=far fa-edit"></i>Mudar Senha</a>
                </center>
              </td>
