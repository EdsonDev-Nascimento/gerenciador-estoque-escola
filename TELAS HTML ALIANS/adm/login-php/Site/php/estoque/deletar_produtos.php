...
<div class="container">
      ...
      <header>
          <div id="titulo">Tem certeza que deseja excluir este produto?</div>
        <form class="form-style-7" name="metodo_post" method="post" action="deletar.php">
        <ul>
        <li>
        ...
        <li>
            ...
            <input type="text" name="tipo_produto" readonly="true" value="<?php echo $result['tipo_produto']?>"></textarea>
            <span>Tipo de Produto</span>
        </li>
        <li>
            <label for="Descrição do Produto">Descrição do Produto</label>
            <input type="text" name="descricao_produto" readonly="true" value="<?php echo $result['descricao_produto']?>">
