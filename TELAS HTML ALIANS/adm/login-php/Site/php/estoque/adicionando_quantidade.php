...
<meta charset="utf-8">
<head>
	<title>Adicionando Quantidade</title>
...
$adiciona_produto = $_POST ['adiciona_produto'];
...
if(empty($id_produto)  || empty($quantidade_produto) || empty($adiciona_produto))
{
...
if($result=mysqli_query($conexao, "UPDATE TbProduto SET quantidade_produto = quantidade_produto + '$adiciona_produto' WHERE id_produto = '$id_produto'") or mysqli_error())
{ 
