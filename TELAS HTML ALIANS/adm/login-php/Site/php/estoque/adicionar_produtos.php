...
<div class="container">
      ...
      <header>
         <div id="titulo">Adicionar a Quantidade</div>
      <form class="form-style-7" name="method_post" action="adicionando_quantidade.php" method="post">
        <ul>
        <li>
        ...
        <li>
            <label for="bio">Quantidade a ser adicionada</label>
            <input type="number" name="adiciona_produto" onkeyup="adjust_textarea(this)"></textarea>
            <span>Quantidade que vai ser adicionada no estoque</span>
        </li>
        <li>
